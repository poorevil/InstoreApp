//
//  MainView_ PromotionActivityCell.h
//  InstoreApp
//
...
@interface MainView_PromotionActivityCell : MainView_BaseCell
...
@property (nonatomic, retain) IBOutlet UILabel *titleLabel_2_1;
@property (nonatomic, retain) IBOutlet EGOImageView *imageView_3;
@property (nonatomic, retain) IBOutlet UILabel *titleLabel_3;
@property (nonatomic, retain) IBOutlet UILabel *titleLabel_3_1;
