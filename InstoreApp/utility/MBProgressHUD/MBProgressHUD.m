...
- (void)drawRect:(CGRect)rect {
	...
	if (self.dimBackground) {
        ...
        CGFloat gradColors_ios7[8] = {0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.35f};
        ...
        if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
            ...
            gradient = CGGradientCreateWithColorComponents(colorSpace, gradColors_ios7, gradLocations, gradLocationsNum);
        }
#endif
