...
@interface ImageFastCATiledLayer : CATiledLayer
@end

@implementation ImageFastCATiledLayer
...
+ layerClass
{
    return [ImageFastCATiledLayer class];
}
...
-(void)setImage:(UIImage *)image
{
    ...
    ImageFastCATiledLayer *tiledLayer = (ImageFastCATiledLayer *)[self layer];
